    ...
    <div>
      {props.article ? (
        <div className='mb-3'>
            ...
            <textarea rows='5' type='text' className = 'form-control' placeholder='Body' value={body}
...

            {
              props.article.id ? (
                ...
                <button className='btn btn-success mt-3' onClick={insertArticle}>Insert Article</button>
              )
            }
